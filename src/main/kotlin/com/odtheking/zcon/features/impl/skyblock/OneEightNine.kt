...
object OneEightNine : Module(
    ...
    @JvmStatic val flapMult by NumberSetting("Cape Flap Multiplier",1,0,5,0.1,"when you walk the cape flaps, this multiplies that effect").withDependency { CustomCapePhysics }
}